...
public partial class SaveData : MonoBehaviour
{
  ...
  public static void Init(ref Info info)
  {
    ...
    info.name = "";
    info.option = new AppConfig.LocalGameOption();
    ...
    switch (Application.systemLanguage)
    {
      case SystemLanguage.Korean:
        info.langType = AppConfig.LanguageType.KOREAN;
        break;
      default:
        info.langType = AppConfig.LanguageType.ENGLISH;
        break;
    }
  }
  //----------------------------------------------------------------------------
  ...
  public class Info : ISerializable
  {
    ...
    public AppConfig.LanguageType langType;
    public AppConfig.LocalGameOption option = new AppConfig.LocalGameOption();
    ...
    public Info(SerializationInfo info, StreamingContext context)
    {
      ...
      try { highScore = (int)info.GetValue("highScore", typeof(int)); }
      catch (SerializationException)
      {
        highScore = 0;
      }
      ...
      try
      {
        langType = (AppConfig.LanguageType)info.GetValue("LangType", typeof(AppConfig.LanguageType));
      }
      catch (SerializationException)
      {
        langType = AppConfig.LanguageType.ENGLISH;
      }
      ...
      try { version = (int)info.GetValue("Version", typeof(int)); }
      catch (SerializationException)
      {
        version = 1;
      }
